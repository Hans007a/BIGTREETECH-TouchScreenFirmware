...
void temp_Change(void)
{
    ...
    if(infoHost.connected == false || infoMenu.menu[infoMenu.cur] == menuPrinting || infoMenu.menu[infoMenu.cur] == menuStatus || infoMenu.menu[infoMenu.cur] == menuMove || infoMenu.menu[infoMenu.cur] == menuPrintFromSource)    return;
